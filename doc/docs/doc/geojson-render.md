...
```
npm install @gaea-explorer/geojson-render
```
...
```typescript
import { renderGeoJson } from '@gaea-explorer/geojson-render';
...
```typescript
import { renderPrimitiveGeoJson } from '@gaea-explorer/geojson-render';
